...
<head>
    ...
    <style>
        ...
        nav {
            ...
            top: 0;
            /* Posisi di bagian atas layar */
            left: 0;
            width: 100%;
            /* Memastikan lebar penuh */
            z-index: 1000;
            /* Supaya navbar berada di depan elemen lain */
            box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.2);
            /* Tambahkan bayangan untuk efek estetika */
        }
        ...
        .search-container .search-bar {
            width: 100%;
            /* Agar input menyesuaikan container */
            padding: 10px 0 10px 15px;
            /* Ruang untuk ikon di sebelah kanan */
            border: none;
            border-radius: 10px;
            background-color: rgba(255, 255, 255, 0.2);
            color: whitesmoke;
